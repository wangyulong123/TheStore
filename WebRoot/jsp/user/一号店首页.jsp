		...
		<div id="header">
			<div class="header-center">
				...
				<div class="header-right" style="z-index: 1000;">
					...
					<!--文本标签-->
					<a id="pregister" href="login.html">Hi,请登录</a>
					<a id="register" href="regist.html">注册</a>
					<span>|</span>
					...
					<script type="text/javascript">
						$(function () {
							$("#kfzx").change(function () {
								location.assign("KFZX/dm/kefuzhongxin.html");
							});
						});
					</script>
					<select name="网站导航">
				...
				<div class="nav-con-left">
					...
					<div class="nav-variety" id="things" >
						<ul class="thing-variety" id="variety" >
							<li class="tab-item" >
								<div class="thname">
									<h4><a href="#" ><img src="图片/进口牛奶.png" />&nbsp;&nbsp;&nbsp;&nbsp;	全球进口</a></h4>
									<span>&gt;</span>
								</div>
							</li>
							<li class="tab-item">
								<div class="thname">
									<h4><a href="freeFood.html"><img src="图片/食品.png" />&nbsp;&nbsp;&nbsp;&nbsp;	食品/酒饮/生鲜</a></h4>
									<span>&gt;</span>
								</div>
							</li>
							<li class="tab-item">
							...
							<li class="tab-item">
								<div class="thname">
									<h4><a href="#"><img src="图片/清洁用品.png" />&nbsp;&nbsp;&nbsp;&nbsp;纸巾/清洁用品</a></h4>
									<span>&gt;</span>
								</div>
							</li>
							<li class="tab-item">
						...
						<div class="dropdown hiden">
							<div class="fmaint clear hiden">
								...
								<div class="subitems">
									<dl class="sub1">
										<dt><a href="#">为您优选<span>&gt;</span></a></dt>
										<dd>
											<a href="#" target="_blank">为您定制</a>
											<a href="#" target="_blank">超然泡面</a>
											<a href="#" target="_blank">全球薯片</a>
											<a href="#" target="_blank">进口坚果</a>
											<a href=# " target="_blank ">酸爽柠檬</a>

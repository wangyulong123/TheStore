				...
				<fieldset class="listFieldset">
						...
						<div>
							<div class="listFieldsetDiv">
								<div class="categoryClass1">
									<label>大图片</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning fileInput"/>
								</div>
							
								<div class="categoryClass2">
									<label>小图片1</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning fileInput"/>
								</div> 
							</div>
							
							<div class="listFieldsetDiv">
								<div class="categoryClass3">
									<label>小图片2</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning fileInput"/>
								</div>
								
								<div class="categoryClass4">
									<label>小图片3</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning fileInput"/>
								</div> 
							</div>
						</div>
					...
					<legend>产品详细页图片</legend>
						<div>
							...
							<div class="listFieldsetDiv">
								<div class="categoryClass3">
									<label>小图片4</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning fileInput"/>
								</div>
								
								<div class="categoryClass4">
									<label>小图片5</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning fileInput"/>
								</div> 
							</div>
						</div>

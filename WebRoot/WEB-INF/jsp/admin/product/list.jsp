<%@ page language="java" import="java.util.*,com.vo.Product,com.page.PageInfo" pageEncoding="UTF-8"%>
<!doctype html>
<html lang="ch">
	...
	<head>
		...
		<style>
			...
			* {
			...
			#plist .gl-item .gl-i-wrap .p-name i,
			em {
				font-style: normal;
				font: 14px/400;
				line-height: 20px;
	...
	%> 
		...
		<div id="shortcut_2013">
			<div class="w">
				...
				<div id="search-2014">
					<form id="categoryForm" action="UserProductServlet?action=getPageByQuery" method="post">
						<div class="form">
						
						
							<input type="text" class="text" id="searchCondition" name="searchCondition"  value="${requestScope.searchCondition}"  />
				...
				<div id="hotwords">
					<a href="" target="_blank" style="color: #ff0000">值得买的手机</a>
					<a href="" target="_blank">手机XX</a>
					<a href="" target="_blank">手机XX</a>
					<a href="" target="_blank">手机XX</a>
					<a href="" target="_blank">手机XX</a>
					<a href="" target="_blank">手机XX</a>
		...
		<div id="nav_2014">
			<div id="" class="w">
				<div id="catgory-2014" class="dorpdown" onmouseleave="hidenAll()" onmouseover="javascript:showAll()">
					<div class="cathead">
						<a href="">全部商品分类</a>
						<i id="ic-right">
						<s>◇</s>
						...
						<div class="bd">
							<ul>
								<li>
									...
									<a href="" class="li-img">
										<img width="100" height="100px" src="img/5716eb58Nf473a48f.jpg" />
									</a>

									<a class="li-txt" href="">
										魅族 PRO5 32GB 银黑色 移动联通双4G手机 双卡双待 京东自营
									</a>
									<h3>￥2499.00</h3>
			...
			<div class="crumbs-bar clearfix">
				<div class="crumbs-nav">
					<div class="crumbs-nav-item one-level">
						<a class="crumbs-link" href="//shouji.jd.com">手机</a>
					...
					<div class="m-list">
						<div class="ml-wrap">
							<div class="f-line filter ">
								...
								<div class="f-pager">
									<span class="fp-txt">
									<b><%=pageInfo.getCurrentPage()%></b>
									<em>/</em>
									<i><%=pageInfo.getTotalPageCount()%></i>
								</span>
									<a id="fp-prevLink" class="fp-prev" href="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getPreviousPage()%>">
										<</a>
											<a id="fp-nextLink" class="fp-next" href="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getNextPage()%>">></a>
								</div>
							</div>
								...
								<ul class="gl-wrap">
									...
									<%
										...
										<div class="gl-i-wrap">
											<div class="p-img">
												<a href="product.html">
													<img width="220" height="220px" src="img/product/<%=product.getProductListLargeImage() %>" />
												</a>
											</div>
											<div class="p-scroll">
												<div class="ps-wrap">
													<ul class="ps-main">
														<li class="ps-item">
															<a href="#" class="plsm_curr">
																<img width="25px" height="25px" src="img/phones/574819cbNd280e8cf.jpg" />
															</a>
														</li>
														<li class="ps-item">
															<a href="#">
																<img width="25px" height="25px" src="img/phones/575fc822N7db81996.jpg" />
															</a>
														</li>
														<li class="ps-item">
															<a href="#">
																<img width="25px" height="25px" src="img/phones/5770fabbN70e56213.jpg" />
															</a>
														</li>
													</ul>
												</div>
							...
							<div class="page">
								<div class="p-wrap">
									<span class="p-num">
									<a id="previous" href="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getPreviousPage()%>" class="pn-prev">
										<i><</i>
										<em>上一页</em>
									</a>
									...
									%>
												<a pageNum="pageNum" href="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=i%>"><%=i%></a>	
									<%
											}
									...
									%>
												...
												<b class="pn-break">...</b>
												<!-- 打印最后一页(即总共的页数) -->
												<a pageNum="pageNum" href="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=totalPageCount%>"><%=totalPageCount%></a>
									<%
											}else if(currentPage<totalPageCount-3){//当前页<总页数-3   8
									%>
												<!--始终打印10个
												先打印1  和 ..  -->
												<a pageNum="pageNum" href="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}&requestPage=1">1</a>
												<b class="pn-break">...</b>
									<%
									...
									<a id="next" href="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getNextPage()%>" class="pn-prev">
										<em>下一页</em>
										<i>></i>
									</a>
								</span>
									...
									<span class="p-skip">
									<form id="productForm2" action="UserProductServlet?action=getPageByQuery&cid=${requestScope.cid}&searchCondition=${requestScope.searchCondition}" method="post">
									...
									<a id="submitProductForm2Link" href="#" class="btn btn-default">确定</a>
									</form>
								</span>
									...
									<div class="mc">
										<ul>
											<li>
												<div class="p-img">
													<a href="#">
														<img width="190" height="190px" src="img/56025e43N6b526078.jpg" />
													</a>
												</div>
												<div class="p-name">
													<a href="#">
														<em>魅族 PRO5 32GB 银黑色 移动联通双4G手机 双卡双待  京东自营</em>
													</a>
												</div>
												<div class="p-price">
													<strong class="price">
    ...
    -->
		<div id="foot">
			...
			<div id="J_promWrap_94" class="w bottom-ad">
				<div class="ad">
					<a href="#">
						<img src="img/5657d2efN0e0c3b76.jpg" />
					</a>
				</div>
			</div>
			<div class="end w">
		...
		<script type="text/javascript">
			$(function() {
				...
				var $plggObj=$("#plist .gl-item .gl-i-wrap").hover(function () {
					$pgpObj.css("visibility","visible").fadeIn(200);
				},function () {
					$pgpObj.css("visibility","hidden").fadeOut(100);
					//$pgpObj.fadeOut(100);
				});

...
public class UserProductServlet extends HttpServlet {
	...
	public void getPageByQuery(HttpServletRequest request, HttpServletResponse response)
		...
		orderCondition.setOrderBy(orderBy);
		...
		try {
			...
			list = service2.getPageByQuery(product, pageInfo,orderCondition);
	...
	public void shangxiajia(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<Product> list = service2.getPageByQuery(product, pageInfo,null);
			request.setAttribute("list", list);
			request.setAttribute("searchCondition", searchCondition);
			request.setAttribute("pageInfo", pageInfo);
			target = "/WEB-INF/jsp/admin/product/"+target+".jsp";
	...
	public void getProductByCategory(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<Product> list = service.getAllByPageByCategory(pageInfo,cid);
	...
	public void getOneProduct(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
